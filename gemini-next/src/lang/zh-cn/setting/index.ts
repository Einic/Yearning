export default {
  ...
  'setting.message.hook.addr': '钉钉hook地址',
  'setting.message.hook.key': '钉钉hook秘钥',
  'setting.message.chathook.addr': '企微hook地址',
  'setting.message.chathook.key': '企微hook秘钥',
  ...
  'setting.message.hook.switch': '钉钉hook推送开关',
  'setting.message.chathook.switch': '企微Hook推送开关',
  'setting.message.mail.switch': 'email推送开关',
  'setting.message.action.mail': '邮件测试',
  'setting.message.action.hook': '钉钉hook测试',
  'setting.message.action.chathook': '企微hook测试',
