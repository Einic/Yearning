...
<!--            <a-input v-model:value="config.message.web_hook"></a-input>-->
            <a-input v-model:value="config.message.web_hook" placeholder="WeChat pushing, fill in 'http://netddr(disloopback):9000'"></a-input>
          </a-form-item>
          ...
          <a-form-item :label="$t('setting.message.chathook.addr')">
            <a-input v-model:value="config.message.chat_hook"></a-input>
          </a-form-item>
          <a-form-item :label="$t('setting.message.chathook.key')">
            <a-input-password
                v-model:value="config.message.chat_key"
            ></a-input-password>
          </a-form-item>
          ...
          <a-form-item :label="$t('setting.message.chathook.switch')">
            <a-switch v-model:checked="config.message.wechat"></a-switch>
          </a-form-item>
          <a-form-item :label="$t('common.action')">
            <a-space>
              <a-button
                  type="primary"
                  @click="testMessageHook('wechat', config)"
              >{{ $t('setting.message.action.chathook') }}</a-button
              >

              <a-button ghost @click="testMessageHook('ding', config)"
