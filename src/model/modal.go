...
type CoreAccount struct {
	...
	IsMfa         uint   `gorm:"type:tinyint(1) not null default 0" json:"is_mfa"`
	Secret        string `gorm:"type:varchar(150);" json:"mfa_secret"`
	Passcode      uint   `gorm:"type:int(6);" json:"passcode"`
}
